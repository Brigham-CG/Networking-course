...
void getListUsers(int socketFD, struct sockaddr_in server_protocols, std::string message) {
    int init = 1;
...
void obtainingMessage(int socketFD, struct sockaddr_in server_protocols, std::string message)
{
    int init = 1;
